---
name: product-is-this-a-problem
description: >
...
读取 `./CLAUDE.md` → `## 风险校准`。本技能的核心目的就是对照该表进行模式匹配。
...
飞书/钉钉分流回复属于内部法律建议。如果回复将被粘贴到广泛与非法律人员共享的工单、文档或频道中，冠以 `./CLAUDE.md` `## 输出规范` 中的工作成果页眉（因用户角色而异——参见 `## 使用者`）：
