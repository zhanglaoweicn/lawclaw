...
function loadMatters(): Matter[] {
  ...
  const demo: Matter[] = [
    ...
    {
      id: generateId(), title: '天行科技诉蓝光公司发明专利侵权纠纷', caseNumber: '(2026)最高法知民终189号',
      client: '天行科技股份有限公司', counterparty: '蓝光科技（深圳）有限公司',
    ...
    },
    {
      ...
      client: '赵晓东（受害方）', counterparty: '钱大军、平安财险北京分公司',
    ...
    {
      id: generateId(), title: '吴某等32户业主诉恒大地产房屋买卖合同纠纷（集体诉讼）', caseNumber: '(2026)京0108民初21037号',
      client: '吴建华等32户业主', counterparty: '恒大地产集团北京有限公司',
      ...
      description: '恒大华府项目停工超18个月，32户业主集体维权，诉请解除合同并返还购房款。',
      opposingCounsel: '恒大法务团队',
